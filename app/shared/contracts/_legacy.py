...
class DocumentPreviewMetadata:
    """Structured ETL metadata returned with document previews."""
...
class DocumentPreviewPayload:
    """Preview text plus structured metadata for the selected document."""
...
class AuthenticatedUser:
    """Normalized authenticated actor resolved from SSO/session context."""
...
class ApplicationAuditRecord:
    """Structured audit trail for application management and authorization events."""
