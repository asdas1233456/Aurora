...
| 页面                | 建议文件名                                 | 当前状态 |
| ------------------- | ------------------------------------------ | -------- |
| 总览 / 主控制台     | ![](./image/README/dashboard-overview.png) | ✅        |
| 知识库 / 控制台视图 | ![](./image/README/knowledge-base.png)     | ✅        |
| 对话 / RAG 问答     | ![](./image/README/chat-workbench.png)     | ✅        |
| 图谱 / 关系视图     | ![](./image/README/knowledge-graph.png)    | ✅        |
| 日志 / 设置页面     | ![](./image/README/logs-settings.png)      | ✅        |
